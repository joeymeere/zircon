    ...
    return (
        <div className="min-h-screen flex-col items-center justify-center bg-transparent">
            <motion.h1
                ...
                className="mt-8 bg-gradient-to-br from-white via-white/90 to-white/25 py-4 pt-56 min-[1920px]:pt-80 bg-clip-text text-center text-4xl font-bold font-plex tracking-tight text-transparent md:text-7xl"
            >
                Go From Zero To
                <br></br>
                Solana Hero
