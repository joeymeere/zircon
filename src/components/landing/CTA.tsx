      ...
      <div className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-zinc-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
            <h2 className="mx-auto max-w-2xl text-center text-3xl font-bold font-plex tracking-tight text-white sm:text-4xl">
              Keep up to date with Zircon.
            </h2>
            <p className="mx-auto mt-2 max-w-xl text-center text-lg font-plex leading-8 text-gray-300">
