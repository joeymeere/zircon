...
export default function SandboxEditor({ code, setCode }: SandboxEditorProps) {
  ...
  useEffect(() => {
    const findCode = () => {
      if (router.query.c) {
        setCode(atob(router.query.c as string));
      }
    };
    findCode();
  }, [router.query.c]);
            ...
            <div className="z-10 sticky top-0 bg-[#09090B] border-b-2 border-[#E851EB]/50 py-2 px-3">
              <div className="flex items-center gap-4 justify-start">
                <button
                  ...
                  className={`px-3 py-1.5 inline-flex gap-2 items-center rounded-md font-plex text-white font-semibold font-neutral-300 ${
                    active == "run"
                      ? "bg-[#E851EB]/50"
                      : "hover:bg-[#E851EB]/25"
                  } transition-colors`}
