...
export async function getStaticProps() {
    ...
    return {
        props: {
            ...
            image: "https://firebasestorage.googleapis.com/v0/b/stockpile-v2-dev.appspot.com/o/images%2Fleaderboard.png?alt=media&token=d466d307-cf3a-4583-97ef-f3b8b2a7d7dc",
        },
        revalidate: 10,
    };
}
