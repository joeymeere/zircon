    ...
    return (
        <>
            ...
            <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.2] relative">
                ...
                >
                    <section className="flex justify-center mb-12 w-full relative">
                        <motion.h1
                            ...
                            className="mt-8 mx-auto bg-gradient-to-br from-white to-white/25 py-4 bg-clip-text text-6xl font-bold font-plex tracking-tight text-transparent text-left"
                        >
                            Challenges
                        </motion.h1>
                    </section>
